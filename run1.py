...
def main():
    ...
    run_experiments(finetune=False, kernel_sizes=(1,), filters=5, lr=1e-3, pooling='logsumexp', kernel_l2_regularization=0.001, other_params=other_params)
    run_experiments(finetune=False, kernel_sizes=(1,2,3,5), filters=5, lr=1e-3, pooling='logsumexp', kernel_l2_regularization=0.001, other_params=other_params)
