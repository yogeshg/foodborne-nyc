...
def main():
    ...
    run_experiments(finetune=False, kernel_sizes=(1,2,3), filters=50, lr=1e-3, pooling='logsumexp', kernel_l2_regularization=0.001, final_layer='softmax', other_params=other_params)
    run_experiments(finetune=False, kernel_sizes=(1,2,3), filters=50, lr=1e-3, pooling='logsumexp', kernel_l2_regularization=0.001, final_layer='twoclass_softmax', other_params=other_params)
